    ...
    try:        
        for x in range(1,4):
            ...
            if username not in prev_user_list:
               ...
               # follow = webdriver.find_element_by_xpath("/html/body/div[1]/section/main/div/div[1]/article/header/div[2]/div[1]/div[2]/button").text
               # print('following ???  '+ follow)
                ...
                if webdriver.find_element_by_xpath("/html/body/div[4]/div[2]/div/article/header/div[2]/div[1]/div[2]/button").text == 'Follow':
                    ...
                    # webdriver.find_element_by_xpath('/html/body/div[4]/div[2]/div/article/header/div[2]/div[2]/div[2]/button').click()
